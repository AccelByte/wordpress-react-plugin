...
- `CLIENT_REGISTER_URI_PATH_NAME` - Client URI path name as entry point to generate PP register URI and redirect to it, ie: "/register-overlay" 
- `CLIENT_LOGIN_URI_PATH_NAME` - Client URI path name as entry point to generate PP login URI and redirect to it, ie: "/login-overlay" 
